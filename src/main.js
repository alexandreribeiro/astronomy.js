...
const AstronomyJS = {
  ...
  getSkyObjectByName: function (objectName) {
    for (const i in this._skyObjects) {
  ...
  getEphemerisTypeByName: function (objectName) {
    for (const i in Constants.EPHEMERIS_TYPE) {
  ...
  getRADecCoordinatesForObject: function (objectName) {
    return this._observer.getRADecCoordinatesForSolarSystemObject(
      this.getSkyObjectByName(objectName),
      this.getJulianDate(),
    );
  },
  getHADecCoordinatesForObject: function (objectName) {
    return this._observer.getHADecCoordinatesForSolarSystemObject(
      this.getSkyObjectByName(objectName),
      this.getJulianDate(),
    );
  },
  getAltAzCoordinatesForObject: function (objectName, referenceDate) {
    ...
    const equatorialCoordinates =
      this._observer.getRADecCoordinatesForSolarSystemObject(
        this.getSkyObjectByName(objectName),
        referenceDate,
      );
    return this._observer.getAltAzCoordinatesForEquatorialCoordinates(
      equatorialCoordinates,
      referenceDate,
    );
  },
  getEphemerisDateForObject: function (
    objectName,
    referenceDate,
    ephemerisTypeName,
  ) {
    ...
    return this._observer.getDateForPositionalEphemeris(
      solarSystemObject,
      TimeHelper.julianDate(referenceDate),
      ephemerisType,
    );
